...
public class SearchServiceTest {
    ...
    public void test1() {
        ...
        User chuckNorris = new User("Чак Норрис");
        ...
        List<User> empty = service.searchForFriendsInDepth(chuckNorris, "Наташа");
        Assert.assertTrue(empty.isEmpty());
        empty = service.searchForFriendsInWidth(chuckNorris, "Наташа");
        Assert.assertTrue(empty.isEmpty());
